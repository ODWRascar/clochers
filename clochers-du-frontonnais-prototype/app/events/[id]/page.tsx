  ...
  if (!evt) {
    return (
      <div className="min-h-screen bg-paper">
        <Header />
        <main className="max-w-4xl mx-auto px-4 py-8">Événement introuvable.</main>
      </div>
    );
  }
  return (
        ...
        <div className="card p-6">
          ...
          <div className="mt-6 flex gap-2">
            ...
            <a
              ...
              href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(evt.lieu + ' ' + evt.clocher)}`}
              target="_blank"
            >
              Itinéraire
            </a>
