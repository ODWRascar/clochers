// clochers-du-frontonnais-prototype/app/api/lectures/route.ts
import { NextResponse } from "next/server";

/**
 * Proxy AELF → évite CORS et permet un cache CDN.
 * Usage: /api/lectures?date=YYYY-MM-DD&zone=romain
 */
